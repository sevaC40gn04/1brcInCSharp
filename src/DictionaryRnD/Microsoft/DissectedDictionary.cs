...
*
*
*  Modifications made by Seva C./1 billion record challenge project, 2024
*
===========================================================*/
...
public class DissectedDictionary<TKey, TValue> : IDictionary<TKey, TValue>, IDictionary, IReadOnlyDictionary<TKey, TValue>, ISerializable, IDeserializationCallback
{
    ...
    public DissectedDictionary() : this(0, null) { }

    public DissectedDictionary(int capacity) : this(capacity, null) { }

    public DissectedDictionary(IEqualityComparer<TKey> comparer) : this(0, comparer) { }

    public DissectedDictionary(int capacity, IEqualityComparer<TKey> comparer)
    {
    ...
    public DissectedDictionary(IDictionary<TKey, TValue> dictionary) : this(dictionary, null) { }

    public DissectedDictionary(IDictionary<TKey, TValue> dictionary, IEqualityComparer<TKey> comparer) :
    ...
    protected DissectedDictionary(SerializationInfo info, StreamingContext context)
    {
    ...
    public int LastHashCollisionCount;
    ...
    {
        private DissectedDictionary<TKey, TValue> dictionary;
        private int version;
        private int index;
        ...
        internal Enumerator(DissectedDictionary<TKey, TValue> dictionary, int getEnumeratorRetType)
        {
...
//    [DebuggerTypeProxy(typeof(Mscorlib_DictionaryKeyCollectionDebugView<,>))]
    ...
    public sealed class KeyCollection : ICollection<TKey>, ICollection, IReadOnlyCollection<TKey>
    {
        ...
        public KeyCollection(DissectedDictionary<TKey, TValue> dictionary)
        {
            if (dictionary == null)
            {
        ...
        public struct Enumerator : IEnumerator<TKey>, System.Collections.IEnumerator
        {
            ...
            internal Enumerator(DissectedDictionary<TKey, TValue> dictionary)
            {
                this.dictionary = dictionary;
                version = dictionary.version;
                index = 0;
    ...
    public sealed class ValueCollection : ICollection<TValue>, ICollection, IReadOnlyCollection<TValue>
    {
        ...
        public ValueCollection(DissectedDictionary<TKey, TValue> dictionary)
        {
            if (dictionary == null)
            {
                //ThrowHelper.ThrowArgumentNullException(ExceptionArgument.dictionary);
